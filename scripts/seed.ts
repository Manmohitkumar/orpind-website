...
async function main() {
  ...
  const categories = await Promise.all([
    prisma.category.create({ data: { name: 'Whole Spices', slug: 'whole-spices', description: 'Premium whole spices sourced directly from Punjab farms', image: '/images/categories/whole-spices.jpg', sortOrder: 1, isActive: true } }),
    prisma.category.create({ data: { name: 'Ground Spices', slug: 'ground-spices', description: 'Freshly ground spices for authentic flavor', image: '/images/categories/ground-spices.jpg', sortOrder: 2, isActive: true } }),
    prisma.category.create({ data: { name: 'Spice Blends', slug: 'spice-blends', description: 'Traditional Punjabi masala blends', image: '/images/categories/spice-blends.jpg', sortOrder: 3, isActive: true } }),
    prisma.category.create({ data: { name: 'Organic Grains', slug: 'organic-grains', description: 'Chemical-free whole grains from Punjab', image: '/images/categories/organic-grains.jpg', sortOrder: 4, isActive: true } }),
    prisma.category.create({ data: { name: 'Organic Flour', slug: 'organic-flour', description: 'Stone-ground organic flour', image: '/images/categories/organic-flour.jpg', sortOrder: 5, isActive: true } }),
    prisma.category.create({ data: { name: 'Herbs & Seasonings', slug: 'herbs-seasonings', description: 'Dried herbs and seasoning blends', image: '/images/categories/herbs.jpg', sortOrder: 6, isActive: true } }),
    prisma.category.create({ data: { name: 'Gift Boxes', slug: 'gift-boxes', description: 'Curated spice gift sets', image: '/images/categories/gift-boxes.jpg', sortOrder: 7, isActive: true } }),
  ]);
  ...
  const products = await Promise.all([
    ...
    prisma.product.create({
      data: {
        ...
        images: ['/images/products/kashmiri-chilli-1.jpg'],
    ...
    prisma.product.create({
      data: {
        ...
        category: 'whole-spices',
        images: ['/images/products/cardamom-1.jpg'],
    ...
    prisma.product.create({
      data: {
        ...
        images: ['/images/products/garam-masala-1.jpg'],
    ...
    prisma.product.create({
      data: {
        ...
        category: 'ground-spices',
        images: ['/images/products/coriander-1.jpg'],
    ...
    prisma.product.create({
      data: {
        ...
        images: ['/images/products/chole-masala-1.jpg'],
    ...
    prisma.product.create({
      data: {
        ...
        images: ['/images/products/basmati-rice-1.jpg'],
    ...
    prisma.product.create({
      data: {
        ...
        images: ['/images/products/wheat-atta-1.jpg'],
